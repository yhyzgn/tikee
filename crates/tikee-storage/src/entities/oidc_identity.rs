...
/// Soft-link mapping from an external OIDC subject to a local tikee user and optional scopes.
...
pub struct Model {
    ...
    pub subject: String,
    /// Local tikee username. This is a soft link; database foreign keys are forbidden.
    pub username: String,
