...
pub(super) fn is_api_token_session(session: &tikee_storage::AuthSessionSummary) -> bool {
    session
        .device_id
        .as_ref()
...
pub(super) fn api_token_summary(session: tikee_storage::AuthSessionSummary) -> ApiTokenSummary {
...
pub(super) fn api_token_scopes(session: &tikee_storage::AuthSessionSummary) -> Vec<String> {
