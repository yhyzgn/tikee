      ...
      <svg className="tikee-logo__mark" width={size} height={size} viewBox="0 0 64 64" fill="none" aria-hidden="true">
        <defs>
          <linearGradient id="tikee-logo-shell" x1="12" y1="7" x2="53" y2="58" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="1" stopColor="var(--tikee-logo-accent)" />
          </linearGradient>
          <linearGradient id="tikee-logo-line" x1="17" y1="31" x2="50" y2="37" gradientUnits="userSpaceOnUse">
            <stop stopColor="var(--tikee-logo-line-start)" />
            <stop offset="0.5" stopColor="var(--tikee-logo-node-fill)" />
            <stop offset="1" stopColor="var(--tikee-logo-line-end)" />
          </linearGradient>
        ...
        <path className="tikee-logo__inner" d="M32 13L47 21.5V42.5L32 51L17 42.5V21.5L32 13Z" fill="var(--tikee-logo-inner-fill)" stroke="var(--tikee-logo-inner-stroke)" strokeWidth="1.6" />
        ...
        <path className="tikee-logo__flow tikee-logo__flow--top" d="M19 25.5H44" stroke="var(--tikee-logo-node-fill)" strokeWidth="3.8" strokeLinecap="round" pathLength="100" />
        <path className="tikee-logo__flow tikee-logo__flow--right" d="M32 35.5H46" stroke="var(--tikee-logo-node-fill)" strokeWidth="3.8" strokeLinecap="round" pathLength="100" />
        <path className="tikee-logo__arrow" d="M41 31L47 35.5L41 40" stroke="var(--tikee-logo-node-fill)" strokeWidth="3.4" strokeLinecap="round" strokeLinejoin="round" />
        <circle className="tikee-logo__node tikee-logo__node--one" cx="19" cy="25.5" r="4.9" fill="var(--tikee-logo-node-fill)" />
        <circle className="tikee-logo__node tikee-logo__node--two" cx="32" cy="25.5" r="4.9" fill="var(--tikee-logo-node-fill)" />
        <circle className="tikee-logo__node tikee-logo__node--three" cx="32" cy="45" r="4.9" fill="var(--tikee-logo-node-fill)" />
        ...
        <circle className="tikee-logo__core tikee-logo__core--three" cx="32" cy="45" r="2" fill="var(--tikee-logo-accent)" />
      </svg>
