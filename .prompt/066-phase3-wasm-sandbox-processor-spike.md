...
2. Evaluate a Rust WASM runtime crate suitable for scheduler worker-side execution with resource limits, timeout, memory cap, env/input isolation, and no ambient network/filesystem by default.
...
5. Update `design/scheduler-architecture-design.md`, `.memory/*`, and create `.prompt/067-*.md`.
